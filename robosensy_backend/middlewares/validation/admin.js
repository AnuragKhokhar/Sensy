...
const adminLoginFields = [
  check("email", "Email field is empty.").exists(),
  check("email", "Invalid Email").isEmail(),
  check("password", "Password should be minimum of 8 characters.").isLength({
    min: 8,
  }),
];
...
const adminRegisterFields = [
  ...
  check("name", "Name field is empty.").exists(),
];
...
export const adminRegisterValidations = [adminRegisterFields, resultChecker];
